        ...
        */
        ...
        if (opModeIsActive()) {
            ...
            if (!isStopRequested() && opModeIsActive()) {
                ...
                if (!isStopRequested() && opModeIsActive()) {
                    strafeDriveEncoder(0.7, 25, "LEFT", 2.0);
                ...
                if (!isStopRequested() && opModeIsActive()) {
                    strafeDriveEncoder(.5, 30, "RIGHT", 2.0);
                }
                ...
                switch (ring) {
                    ...
                    case "Single":
                        if (!isStopRequested() && opModeIsActive()) {
                            ...
                            if (opModeIsActive()) {
                                strafeDriveEncoder(.8, 30, "RIGHT", 2);
                            }
                                if (opModeIsActive()) {
                            ...
                            if (opModeIsActive()) {
                                straightDriveEncoder(.9, -135, 3.2);
                            }
                            intakerelease.setPosition(.36);
                            break;
                        }
