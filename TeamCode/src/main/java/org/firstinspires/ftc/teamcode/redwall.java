...
//         **/
        ...
        while (opModeIsActive()) {
            ...
            strafeDriveEncoder(0.7, 125, "LEFT", 2.7);
            straightDriveEncoder(0.4, 125, 3.2);

            strafeDriveEncoder(.5, 55, "RIGHT", 3);
            sleep(1000);
...
//                        straightDriveEncoder(.2, -130, 3.2);
                ...
                case "Single":
                    if (!isStopRequested() && opModeIsActive()) {
                        ...
                        straightDriveEncoder(.4, 120, 3.8);
//                        straightDriveEncoder(.4, -60, 3.2);
                        Wobble.setPower(0);
                        sleep(1200);
                        gripper.setPosition(.46);
                        strafeDriveEncoder(.6, 20, "RIGHT",1);
